...
ActiveRecord::Schema[8.0].define(version: 2025_09_15_063422) do
  ...
  create_table "blog_articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bureau_id"], name: "index_blog_articles_on_bureau_id"
  end

  create_table "blog_bureaus", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
